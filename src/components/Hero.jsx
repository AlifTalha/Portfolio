...
export default function Hero() {
    ...
    if (!isDeleting && typedName === fullName) {
      ...
      timeoutId = setTimeout(() => {
        setTypedName((current) =>
          isDeleting
            ? fullName.substring(0, current.length - 1)
            : fullName.substring(0, current.length + 1),
        );
      }, typeSpeed);
    }
  ...
  const handleDownloadCV = () => {
    ...
    setTimeout(() => {
      ...
      link.href = cvPDF;
      link.download = "ALIF_TALHA_CV.pdf";
          ...
          <div className="hero-content">
            ...
            >
              ...
              <span className="typewriter-wrapper">
                <span className="typewriter-shadow" aria-hidden="true">
                  {fullName}
                  <span className="title-cursor title-cursor-shadow">|</span>
                </span>
                <span className="highlight typewriter-content">
                  {typedName}
